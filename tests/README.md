...
**Tests**: 21 total (15 happy + 6 error)
...
**Endpoints**: 9 (4 Project + 4 Task + 1 User)  
**Tests**: 21 total (18 happy + 3 error)
...
**Tests**: 12 total (3 happy + 9 error)
...
- Tests create test data (organizations, users, projects, tasks)
- Each scenario is independent - can run separately
- Color-coded output requires terminal with ANSI color support
